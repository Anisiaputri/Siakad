...
public class FrMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbKeterangan, javax.swing.GroupLayout.PREFERRED_SIZE, 310, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        txtIdUser.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true))), "ID. User :"));
        ...
        mnLapMahasiswa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Report-medium2.png"))); // NOI18N
        mnLapMahasiswa.setText("Lapor Data Mahasiswa");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        if(txtIdUser.getText().equals("") || txtPass.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Silakan lengkapi data !", "Informasi", JOptionPane.INFORMATION_MESSAGE);
        }else{
            aksiLogin();
        }
...
// Keterngan
/*
1. Deklarasi terlebih dahulu variabel-variabel nama pada form login dan menu
2. Import file class library yang dibutuhkan
3. Deklarasikan objek database dan class connection
4. Deklarasikan variabel-variabel yang dibutuhkan untuk operasi  login
5. Buat method eneble() dan disable() menu
6. Buat method aksiLogin()
7. Tambahkan sintak pada method contructor
8. Ubah sintak mthod main
